 ...
 * @author Asus
 */
public class LaporanFormAdmin extends javax.swing.JFrame {

    /**
     * Creates new form LaporanForm
     */
    public LaporanFormAdmin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnlLaporan.setBackground(new java.awt.Color(27, 117, 188));
...
//        lblLaporan.setForeground(new Color(27,117,188));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanFormAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LaporanFormAdmin().setVisible(true);
            }
        });
    }
