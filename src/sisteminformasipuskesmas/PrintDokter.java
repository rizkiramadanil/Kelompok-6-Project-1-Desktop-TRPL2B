 ...
 * @author Asus
 */
public class PrintDokter extends javax.swing.JFrame {

    /**
     * Creates new form PrintDokter
     */
    public PrintDokter() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintDokter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrintDokter().setVisible(true);
            }
        });
    }
