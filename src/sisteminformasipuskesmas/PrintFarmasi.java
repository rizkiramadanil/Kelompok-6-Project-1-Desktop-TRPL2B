 ...
 * @author Asus
 */
public class PrintFarmasi extends javax.swing.JFrame {

    /**
     * Creates new form PrintFarmasi
     */
    public PrintFarmasi() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintFarmasi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrintFarmasi().setVisible(true);
            }
        });
    }
